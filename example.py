...
plt.savefig('./gallery/example_map.jpg', dpi=300, bbox_inches='tight')
...
plt.legend()
plt.savefig('./gallery/example_hist.jpg', dpi=300, bbox_inches='tight')

# 7. 檢查均勻網格分佈
print("\nStep 7: Checking even grid distribution...")
plt.figure()
plt.scatter(even_lon, even_lat, s=1)
plt.savefig('./gallery/example_grid.jpg', dpi=300, bbox_inches='tight')
...
plt.savefig('./gallery/example_reconstruction.jpg', dpi=300, bbox_inches='tight')
